...
namespace Game
{
    public class TerrainGrid : MonoBehaviour
    {
        ...
        public event TerrainChangedEventHandler OnTerrainChanged;
        ...
        private void UpdateTerrainMesh()
        {
            ...
            StopAllCoroutines();
            StartCoroutine(UpdateTerrainMeshRoutine());
        }

        private IEnumerator UpdateTerrainMeshRoutine()
        {
            ...
            if (blocks != null)
            {
                ...
                var worldSize = WorldSize;
                bottomGameObject.transform.position = new Vector3(worldSize.x / 2f, grassBlockHeight - scale, worldSize.z / 2f);
        ...
        {
            if (OnTerrainChanged != null) OnTerrainChanged();
        }
    ...
    public class TerrainBlock
    {
        ...
        public Vector3 WorldPosition
        {
            get
            {
                ...
                return localPosition + terrain.transform.position;
            }
        }
